<!-- Display users status. 'whichStatus' gets the value in utilities.js-$(document).ready(function() -->
<?php
  ...
  } // Check everyone's status except sender's
  ...
  // Chech the last time of a user being active
